...
<head>
	...
	<title>DIAMBAMBA Student Residence Registration</title>
...
<script type="text/javascript" src="http://code.jquery.com/jquery.min.js"></script>
	<!--added code for search function in enrolled course-->
<!--link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.13/css/select2.min.css"-->	
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.13/js/select2.min.js"></script>
<!--added code above(three lines of code)-->
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-primary"style="background-color: grey; color: black;">
									<div class="panel-heading"style="background-color: black; color: black;">REQUIRED </div>
									<!--div class="panel-heading"style="background-color: black; color: white;">Fill all Info</div-->
...
$uid=$_SESSION['login'];
				...
				if($rs)
				{ ?>
			<h3 style="color: red" align="center"> Room Secured ! </h3>
			<div align="center">
...
<label class="col-sm-4 control-label"><h4 style="color: white; font-weight: bold; text-shadow: 2px 2px 4px black;"
 align="left">DIAMBAMBA Residence:Booking details  </h4> </label>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label"> Monthly Payment</label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-2 control-label">Meal Status</label>
<div class="col-sm-8">
<input type="radio" value="0" name="foodstatus" checked="checked"> Meals Excluded
<input type="radio" value="1" name="foodstatus"> Meals Included (*ZAR 2000.00 added to monthly payment )
</div>
</div>	
...
<option value="">Select Duration(designated in monththly terms)</option>
...
<div class="form-group">
<label class="col-sm-2 control-label"><h4 style="color: white; font-weight: bold; text-shadow: 2px 2px 4px black;" align="left">Personal Details </h4> </label>
</div>

<div class="form-group">
<label class="col-sm-2 control-label">Enrolled Course </label>
<div class="col-sm-8">
...
$stmt2->execute();
$res=$stmt2->get_result();
//added code for search functionality
?>
<option value="" disabled>Search for a course...</option>
<?php
//end of added code for search functionality
while($row=$res->fetch_object())
{
?>
...
<div class="form-group">
<label class="col-sm-2 control-label">Relation with Guardian : </label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-2 control-label">Contact number of Guardian : </label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-3 control-label"><h4 style="color: white; font-weight: bold; text-shadow: 2px 2px 4px black;" align="left">Postal Address </h4> </label>
</div>
...
<div class="form-group">
<label class="col-sm-3 control-label"><h4 style="color: white; font-weight: bold; text-shadow: 2px 2px 4px black;" align="left">Residential Address </h4> </label>
</div>


<div class="form-group">
<label class="col-sm-5 control-label">Residential Address same with Postal address : </label>
<div class="col-sm-4">
...
<!--- personal addition to code  -->
<div class="form-group">
<label class="col-sm-3 control-label"><h4 style="color: white; font-weight: bold; text-shadow: 2px 2px 4px black;" align="left">Billing Method </h4> </label>
</div>

<!--<div class="form-group">
<label class="col-sm-5 control-label"><i class="fa fa-paypal"style=color:blue></i> Paypal: </label>
<div class="col-sm-4">
<input type="radio" name="adcheck" value="1"/>
</div>
</div>-->

<div class="form-group">
<label class="col-sm-5 control-label"><i class="fa fa-google-wallet" style=color:orange></i> E-wallet: </label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-5 control-label"><i class="fa fa-bank"style=color:red></i> Bank Transfer: </label>
<div class="col-sm-4">
<input type="radio" name="payment" value="1"/>
</div>
</div>

<!---end of personal addition to code --->



<div class="col-sm-6 col-sm-offset-4">
<button class="btn btn-default" type="submit"style="color: white; background-color: red; font-weight: bold; text-shadow: 1px 1px 2px black;">CANCEL</button>
<input type="submit" name="submit" Value="REGISTER" class="btn btn-primary"style="background-color: green; color: white; text-shadow: 1px 1px 2px white;">
</div>
</form>
...
<?php } ?>
	...
	<!--added code for search functionality in enrolled course-->
<script>
$(document).ready(function() {
    $('#course').select2();
});
</script>
<!--end of added code for search functionality in enrolled course-->
