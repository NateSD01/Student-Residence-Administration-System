...
//echo "<span style='color:red'>$count BOOKED!choose another Floor.</span>";
echo "<span style='color: red; font-weight: bold'>$count BOOKED! Choose another Floor.</span>";

else
	//echo "<span style='color:red'>All Seats are Available</span>";
	//echo "<span style='color:red'>AVAILABLE TO BE BOOKED! </span>";
	echo "<span style='color: red; font-weight: bold'>AVAILABLE TO BE BOOKED!</span>";
