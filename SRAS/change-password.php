...
<div class="form-group">
				...
				<input type="password" class="form-control" value="" required="required" id="cpassword" name="cpassword" >
												...
												<div class="col-sm-6 col-sm-offset-4">
													...
													<button class="btn btn-danger" type="submit" style="color: black; background-color: red; font-weight: bold; text-shadow: 1px 1px 2px white;">CANCEL</button>
													<!--input type="submit" name="changepwd" Value="Change Password" class="btn btn-primary"-->
													<input type="submit" name="submit" Value="CHANGE PASSWORD" class="btn btn-primary" style="background-color: green; color: white; text-shadow: 1px 1px 2px black;">
											</div>
